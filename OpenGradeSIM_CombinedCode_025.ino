...
#define buttonUpPin 5
#define buttonDownPin 6

// Declare our filters
MovingAverageFilter movingAverageFilter_x(8);        // 
MovingAverageFilter movingAverageFilter_y(8);        // Moving average filters for the accelerometers
MovingAverageFilter movingAverageFilter_z(8);        //
MovingAverageFilter movingAverageFilter_power(12);   // 3 second power average at 4 samples per sec
MovingAverageFilter movingAverageFilter_speed(8);    // 2 second speed average at 4 samples per sec
...
float versionNumber = 0.25;       // version
...
int riderWeight = 90;             // variable for combined rider and bike weight
...
int wheelCircCM = 2155;           // Wheel circumference in centimeters (700c 32 road wheel)
